...
const CustomersPage: React.FC = () => {
    ...
    const filteredCustomers = useMemo(() => {
        ...
        return customers.filter(customer =>
            (customer.fullName && customer.fullName.toLowerCase().includes(lowercasedQuery)) ||
            (customer.companyName && customer.companyName.toLowerCase().includes(lowercasedQuery)) ||
            (customer.cpf && customer.cpf.includes(lowercasedQuery)) ||
            (customer.cnpj && customer.cnpj.includes(lowercasedQuery))
        );
